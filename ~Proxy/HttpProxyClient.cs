...
namespace Tuan.Net.X
{
    ...
    public sealed class HttpProxyClient : ProxyClient
    {
        ...
        /// <inheritdoc />
        /// <summary>
        /// Инициализирует новый экземпляр класса <see cref="T:Tuan.Net.X.HttpProxyClient" />.
        /// </summary>
        ...
        /// <inheritdoc />
        /// <summary>
        /// Инициализирует новый экземпляр класса <see cref="T:Tuan.Net.X.HttpProxyClient" /> заданными данными о прокси-сервере.
        /// </summary>
