...
namespace Tuan.Net.X
{
    ...
    public sealed class HttpRequest : IDisposable
    {
        ...
        /// <remarks>Куки могут изменяться ответом от HTTP-сервера. Чтобы не допустить этого, нужно установить свойство <see cref="CookieStorage.IsLocked"/> равным <see langword="true"/>.</remarks>
