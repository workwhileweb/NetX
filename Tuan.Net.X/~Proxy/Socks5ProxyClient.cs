...
namespace Tuan.Net.X
{
    ...
    public sealed class Socks5ProxyClient : ProxyClient
    {
        ...
        /// <inheritdoc />
        /// <summary>
        /// Инициализирует новый экземпляр класса <see cref="T:Tuan.Net.X.Socks5ProxyClient" />.
        /// </summary>
        ...
        /// <inheritdoc />
        /// <summary>
        /// Инициализирует новый экземпляр класса <see cref="T:Tuan.Net.X.Socks5ProxyClient" /> заданными данными о прокси-сервере.
        /// </summary>
